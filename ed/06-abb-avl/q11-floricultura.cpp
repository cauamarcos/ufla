...
class avl {
    ...
    private:
        ...
        void percorreEmOrdemAux (noh* umNoh, int& contador, string cultivar, string marca);
...
void avl::percorreEmOrdemAux (noh* umNoh, int& contador, string cultivar, string marca) {
    if (umNoh != NULL) {
        percorreEmOrdemAux (umNoh->esq, contador, cultivar, marca);
        ...
        percorreEmOrdemAux (umNoh->dir, contador, cultivar, marca);
    }
}
...
int avl::levantamento (string cultivar, string marca) {
    int cont = 0;
    percorreEmOrdemAux (raiz, cont, cultivar, marca);
    return cont;
}
