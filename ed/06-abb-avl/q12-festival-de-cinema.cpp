...
class avl {
    ...
    private:
        ...
        void percorreEmOrdemAux (noh* umNoh, unsigned& ano, int& cont);
...
void avl::percorreEmOrdemAux (noh* umNoh, unsigned& ano, int& qtd) {
    if (umNoh != NULL) {
        percorreEmOrdemAux (umNoh->esq, ano, qtd);
        if (umNoh->elemento.qtdadeFilmesApresentados > qtd or (umNoh->elemento.qtdadeFilmesApresentados == qtd and umNoh->elemento.ano < ano)) {
            qtd = umNoh->elemento.qtdadeFilmesApresentados;
            ano = umNoh->elemento.ano;
        }
        percorreEmOrdemAux (umNoh->dir, ano, qtd);
    }
}
...
int avl::levantamento () {
    ...
    unsigned ano;
    int qtd;
    noh* umNoh = encontraMenor (raiz);
    ano = umNoh->elemento.ano;
    qtd = umNoh->elemento.qtdadeFilmesApresentados;
    percorreEmOrdemAux (raiz, ano, qtd);
    return ano;
}
